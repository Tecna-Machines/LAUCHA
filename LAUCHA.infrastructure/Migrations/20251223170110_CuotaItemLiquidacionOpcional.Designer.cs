...
namespace LAUCHA.infrastructure.Migrations
{
    ...
    [Migration("20251223170110_CuotaItemLiquidacionOpcional")]
    partial class CuotaItemLiquidacionOpcional
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LAUCHA.domain.Entities.Creditos.CuotaCredito", b =>
                {
                    ...
                    b.HasIndex("CodigoLiquidacion", "NroItem");
            ...
            modelBuilder.Entity("LAUCHA.domain.Entities.Creditos.CuotaCredito", b =>
                {
                    ...
                    b.HasOne("LAUCHA.domain.Entities.Liquidaciones.ItemLiquidacion", null)
                        .WithMany()
                        .HasForeignKey("CodigoLiquidacion", "NroItem")
                        .OnDelete(DeleteBehavior.Restrict);
                });
            ...
            modelBuilder.Entity("LAUCHA.domain.entities.diasEspeciales.HabilitacionHorasExtra", b =>
                {
                    ...
                    b.HasOne("LAUCHA.domain.Entities.Empleados.Empleado", "Responsable")
                        .WithMany()
