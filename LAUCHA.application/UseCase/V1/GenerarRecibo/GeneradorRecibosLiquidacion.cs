...
//{
//    public class GeneradorRecibosLiquidacion : IGeneradorRecibosViejo
//    {
//        private readonly ISistemaMarcas _marcasService;
...
//        public GeneradorRecibosLiquidacion(ILogsApp log, ISistemaMarcas marcasService)
//        {
...
//            var marcas = _marcasService.GetDesdePeriodoVista(liquidacion.Dni, liquidacion.Periodo.Inicio, liquidacion.Periodo.Fin);
...
//        private void GenerarPaginaMarcas(iText.Layout.Document document, PageSize ps, LiquidacionDTO liquidacion, List<MarcaResponse> marcas)
//        {
...
//            {
//                MarcaResponse? marcaDelDia = marcas.FirstOrDefault(m => m.Ingreso.Date == fechaActual.Date);
