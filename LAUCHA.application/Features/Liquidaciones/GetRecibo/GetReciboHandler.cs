...
namespace LAUCHA.application.Features.Liquidaciones.GetRecibo
{
    internal class GetReciboHandler : IGetRecibo
    {
        ...
        public async Task<Result<GetReciboLiquidacionResponse>> Get(GetReciboLiquidacionRequest req)
        {
            ...
            var feriadosResult = await _feriadosMes.Get(
                liquidacionResult.Value.Quincena.Mes,
                liquidacionResult.Value.Quincena.Anio);
            ...
            var reciboRequest = new ReciboRequest(
                liquidacion,
                asistencias,
                feriados);


            var recibo = _renderer.Render(reciboRequest);
